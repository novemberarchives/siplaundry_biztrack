...
@section('content')
    ...
    <div class="w-full max-w-lg mx-auto space-y-6">
        ...
        <!-- Main Bento Card (+1 Sizing: More Padding) -->
        <div class="bg-white dark:bg-gray-800 p-8 md:p-10 rounded-[2.5rem] shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700">
            ...
            <header class="text-center mb-10">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 font-medium mt-2">Register new stock details below.</p>
            </header>
            ...
            <!-- Inventory Create Form (+1 Sizing: Larger gaps and inputs) -->
